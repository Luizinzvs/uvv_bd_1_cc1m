/* Realizando a operação de entrar no terminal, criar o meu usuário e logar com o mesmo no MariaDB
mysql -u root -p
computacao@raiz
CREATE USER "luizfelipe" IDENTIFIED BY '202202858';
GRANT ALL ON *.* TO luizfelipe@localhost;

mysql -u luizfelipe -r
202202858 */
...
/* Comentários referentes a tabela de cargos e suas colunas */
ALTER TABLE cargos COMMENT 'Tabela cargos, que armazena os cargos da empresa e a média salarial (mínimo e máximo) para cada cargo existente na empresa.';

ALTER TABLE cargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'É a chave primária da tabela cargos.';

ALTER TABLE cargos MODIFY COLUMN cargo VARCHAR(35) COMMENT 'É uma chave unica da tabela cargos. Nome dos cargo existentes da empresa.';

ALTER TABLE cargos MODIFY COLUMN salario_minimo DECIMAL(8, 2) COMMENT 'O menor salário de um cargo.';

ALTER TABLE cargos MODIFY COLUMN salario_maximo DECIMAL(8, 2) COMMENT 'O maior salário de um cargo.';

/* Criando o index de cargos */
...
/* Comentários referentes a tabela de regiões e suas colunas */
ALTER TABLE regioes COMMENT 'Tabela regiões em que contém o nome das regiões.';

ALTER TABLE regioes MODIFY COLUMN id_regiao INTEGER COMMENT 'É a chave primária da tabela regiões.';

ALTER TABLE regioes MODIFY COLUMN nome VARCHAR(25) COMMENT 'chave única da tabela regiões.';

/* Criando o index de regiões */
...
/* Comentários referentes a tabela de países e suas colunas */
ALTER TABLE paises COMMENT 'Tabela países em que contém as informações dos países.';

ALTER TABLE paises MODIFY COLUMN id_pais CHAR COMMENT 'É a chave primária da tabela países.';

ALTER TABLE paises MODIFY COLUMN nome VARCHAR(50) COMMENT 'É a chave unica da tabela paises.';

ALTER TABLE paises MODIFY COLUMN id_regiao INTEGER COMMENT 'É uma chave estrangeira para a tabela de regiões.';

/* Criando o index de países */
CREATE UNIQUE INDEX paises_idx
 ON paises
 ( nome );

/* Criando a tabela localizções */
...
/* Comentáios referentes a tabela de localizações e suas colunas */
ALTER TABLE localizacoes COMMENT 'Tabela localizações em que contém varios endereços de escritórios e dados da empresa. Não armazena os endereços dos clientes.';

ALTER TABLE localizacoes MODIFY COLUMN id_localizacao INTEGER COMMENT 'É uma chave primária da tabela localizações.';

ALTER TABLE localizacoes MODIFY COLUMN endereco VARCHAR(50) COMMENT 'Endereço de um escritório ou facilidade da empresa.';

ALTER TABLE localizacoes MODIFY COLUMN cep VARCHAR(12) COMMENT 'É o CEP da localização de algum certo escritório da empresa.';

ALTER TABLE localizacoes MODIFY COLUMN cidade VARCHAR(50) COMMENT 'Cidade onde está localizado o escritório da empresa.';

ALTER TABLE localizacoes MODIFY COLUMN uf VARCHAR(25) COMMENT 'Estado onde está localizado o escritório da empresa.';

ALTER TABLE localizacoes MODIFY COLUMN id_pais CHAR COMMENT 'É uma chave estrangeira para a tabela países.';
...
/* Comentários referentes a tabela de departamentos e suas colunas */
ALTER TABLE departamentos COMMENT 'É a tabela que contém as informações sobre os departamentos da empresa.';

ALTER TABLE departamentos MODIFY COLUMN id_departamento INTEGER COMMENT 'É a chave primária da tabela departamentos.';

ALTER TABLE departamentos MODIFY COLUMN nome VARCHAR(50) COMMENT 'la departamentos.';

ALTER TABLE departamentos MODIFY COLUMN id_localizacao INTEGER COMMENT 'É a chave estrangeira para a tabela de localizações.';

ALTER TABLE departamentos MODIFY COLUMN id_gerente INTEGER COMMENT 'É a chave estrangeira para a tabela de empregados.';

/* Criando o index de departamentos */
...
/* Comentários referentes a tabela de empregados e suas colunas */
ALTER TABLE empregados COMMENT 'É a tabela que contém todas as informações dos empregados.';

ALTER TABLE empregados MODIFY COLUMN id_empregado INTEGER COMMENT 'É a chave primária da tabela empregados.';

ALTER TABLE empregados MODIFY COLUMN nome VARCHAR(75) COMMENT 'Nome completo de um empregado.';

ALTER TABLE empregados MODIFY COLUMN email VARCHAR(35) COMMENT 'Parte inicial (Anterior ao @) do email de um empregado.';

ALTER TABLE empregados MODIFY COLUMN telefone VARCHAR(20) COMMENT 'Telefone do empregado com o DDD e o código do País.';

ALTER TABLE empregados MODIFY COLUMN data_contratacao DATE COMMENT 'Data em que o empregado foi contratado.';

ALTER TABLE empregados MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Cargo do empregado.';

ALTER TABLE empregados MODIFY COLUMN salario DECIMAL(8, 2) COMMENT 'Indica o salário mensal atual de um empregado.';

ALTER TABLE empregados MODIFY COLUMN comissao DECIMAL(4, 2) COMMENT 'Comissão de um empregado. Disponivel apenas para empregados do departamento de vendas.';

ALTER TABLE empregados MODIFY COLUMN id_departamento INTEGER COMMENT 'É uma chave estrangeira para a tabela de departamentos. É o departamento atual do funcionario.';

ALTER TABLE empregados MODIFY COLUMN id_supervisor INTEGER COMMENT 'Indica um auto-relacionamento com a própria tabela empregados. ';

/* Criando o index de empregados */
CREATE UNIQUE INDEX empregados_idx
 ON empregados
 ( email );

/* Criando a tabela histórico cargos */
...
/* Comentários referentes a tabela histórico cargos */
ALTER TABLE historico_cargos COMMENT 'Tabela que armazena o histórico de cargos de um empregado. Caso o empregado mude seu cargo ou seu departamento, novas linhas deverão ser inseridas nessa tabela com as informações antigas dele.';

ALTER TABLE historico_cargos MODIFY COLUMN id_empregado INTEGER COMMENT 'É parte de uma chave primária da tabela historico_cargos. Também é uma chave estrangeira para a tabela empregados.';

ALTER TABLE historico_cargos MODIFY COLUMN data_inicial DATE COMMENT 'Chave primária da tabela historico cargos. Data em que o empregado iniciou no novo cargo. Deve ser menor do que a data final.';

ALTER TABLE historico_cargos MODIFY COLUMN data_final DATE COMMENT 'Ultimo dia em que o empregado permaneceu no cargo. Deve ser maior que a data inicial.';

ALTER TABLE historico_cargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'É uma chave estrangeira para a tabela de departamentos. Departamento em que o empregado trabalhou no passado.';

ALTER TABLE historico_cargos MODIFY COLUMN id_departamento INTEGER COMMENT 'É uma chave estrangeira para a tabela de departamentos. Departamento em que o empregado trabalhou no passado.';


/* Realizando alterações de chaves e relacionamentos na tabela empregados */
...
/* Realizando alterações de chaves e relacionamentos na tabela histórico cargos */
...
/* Realizando alterações de chaves e relacionamentos na tabela países */
...
/* Realizando alterações de chaves e relacionamentos na tabela localizações */
...
/* Realizando alterações de chaves e relacionamentos na tabela departamentos */
...
/* Inserindo dados na tabela historico cargos */
